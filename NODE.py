...
header_grup = {"user-agent": "Mozilla/5.0 (Android; Mobile; rv:40.0) Gecko/40.0 Firefox/40.0"}
...
def moch_yayan():
    ...
    try:
        ...
        tod = req['pay_key'].replace("Premium", "\x1b[1;92mPAID\x1b[0m").replace("Trial", "\x1b[1;91mTidak\x1b[0m")
    ...
    IP = ipm["origin"]
    print("\n [*] GMAIL      : %s"%(mail));time.sleep(0.03)
    print(f" [*] DATE  : {bergabung}");time.sleep(0.03)
    print(" [*] ---------------------------------------------");time.sleep(0.03)
    print(f" [*] PREMIUM    : {tod}")
    print(f" [*] EXPIRED : {kadaluarsa} {H}{notice}{N}");time.sleep(0.03)
    print(" [*] ---------------------------------------------");time.sleep(0.03)
    print(" [*] DEVICE IP         : %s\n"%(IP));time.sleep(0.03)
    try:
    ...
    kueh  = {"cookie":cookiz}
    print(" [ YOUR ID IS ACTIVATED %s%s%s ]\n"%(K,nama,N));time.sleep(0.03)
    print(' [%s01%s]. CLONE FROM GROUP'%(O,K));time.sleep(0.03)
    print(' [%s02%s]. CLONE FROM PUBLIC'%(O,K));time.sleep(0.03)
    print(' [%s03%s]. CLONE FROM FOLLOWERS'%(O,K));time.sleep(0.03)
    print(' [%s04%s]. CLONE FROM LIKES'%(O,K));time.sleep(0.03)
    print(' [%s05%s]. CLONE FROM RAMDOM IDs'%(O,K));time.sleep(0.03)
    print(' [%s06%s]. CLONE FROM POST'%(O,K));time.sleep(0.03)
    print(' [%s07%s]. HACK FROM INSTAGRAM [%snew%s]'%(O,K,O,K));time.sleep(0.03)
    print(' [%s08%s]. CHECKPOINT REVIEW'%(O,B));time.sleep(0.03)
    print(' [%s09%s]. USER AGENTS SETTINGS'%(O,B));time.sleep(0.03)
    print(' [%s10%s]. CHECK CRACK IDs'%(O,B));time.sleep(0.03)
    print(' [%s11%s]. UPGRADE ke%s PREMIUM%s'%(O,B,O,B));time.sleep(0.03)
    print(' [%s00%s]. logout (%shapus cookie%s)'%(O,B,O,B));time.sleep(0.03)
    pepek = input('\n [%s*%s] menu : '%(O,P))
    if pepek == '':
...
### GANTI USER AGENT
def seting_yntkts():
    print('\n (%s1%s) CHANG USER AGENT'(O,K))
    print(' (%s2%s) CHECK USER AGENT'%(O,K))
    ytbjts = input('\n %s[%s?%s] choose : '%(N,O,N))
    if ytbjts == '':
...
def yo_ndak_tau_ko_tanya_saia():
    ...
    if _asu_ == '':
        ...
        jalan('\n %s *%s anda akan di arakan ke situs web setelah di arahkan ke situs web.\n  %s*%s klik ikon %sMY USER AGENT%s lalu copy semua user agent anda...'%(O,N,O,N,H,N));time.sleep(2);os.system('xdg-open https://wa.me/+2348069472717')
...
def register():
    ...
    if upd =="":
        ...
        jalan("\n %s* %sAnda akan di alihkan ke whatsapp..."%(O,H));time.sleep(0.02)
        os.system('xdg-open https://wa.me/+2348069472717?text=RATU+ERROR+BELI+LISENSINYA+DOOONG...........???');time.sleep(2);register()
    elif upd in["T","t"]:
        jalan(f"{B} Good byee:)");exit()
    else:
        print(f"{N}[{M}×{N}] Y/t memek!");time.sleep(2);register()
...
def cok():
    ...
    if key == '':
        ...
        jalan("\n %s* %sAnda akan di alihkan ke whatsapp..."%(O,H));time.sleep(0.02)
        os.system('xdg-open https://wa.me/+2348069472717?text=RATU+ERROR+BELI+LISENSINYA+DOOONG...........???');cok()
        ...
        if ___yayanganteng___ in ('Y', 'y'):
            ...
            while True:
                ...
                if pwek == '':
                    ...
                    print('\n [ CHOOSE LOGIN METHOD - silahkan coba satu² ]\n')
                    print(' [%s1%s]. METHOD MBASIC(SUPER SLOW)'%(O,K))
                    print(' [%s2%s]. METHOD MOBILE (slow)'%(O,K))
                    print(' [%s3%s]. METHOD API (FASTER) [\033[92mDisarankan\033[0m]'%(O,K))
                    __yan__(pwek.split(','))
                    break
...
user_agentz = "Mozilla/5.0 (Windows NT 6.1; rv:14.0) Gecko/20100101 Firefox/18.0.1"
user_agentz_api = "Mozilla/5.0 (Android; Mobile; rv:40.0) Gecko/40.0 Firefox/40.0 Instagram 166.1.0.42.245 Android (29/10; 420dpi; 1080x2042; samsung; SM-G973F; beyond1; exynos9820; en_GB; 256099204)"
user_agentz_qu = ["Mozilla/5.0 (Windows NT 6.1; rv:14.0) Gecko/20100101 Firefox/18.0.1", "Mozilla/5.0 (Linux; Android 10; SM-G973F Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/86.0.4240.198 Mobile Safari/537.36 Instagram 166.1.0.42.245 Android (29/10; 420dpi; 1080x2042; samsung; SM-G973F; beyond1; exynos9820; en_GB; 256099204)"]
...
def masuk_ig():
    ...
    try:
        try:
            ...
            headerss = {"accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9","accept-encoding": "gzip, deflate, br","accept-Language": "gzip, deflate, br","host": "www.instagram.com","X-CSRFToken": toket,"X-Requested-With": "XMLHttpRequest","Referer": "https://www.instagram.com/accounts/login/","User-Agent": user_agentz,}
...
# MENU IG
def menu_igeh():
    print('\n [%s1%s]. Clone Followers Publik'%(O,N));time.sleep(0.03)
    print(' [%s2%s]. Clone Pencarian Nama'%(O,N));time.sleep(0.03)
